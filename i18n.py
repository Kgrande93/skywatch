...
STRINGS = {
    "no": {
        ...
        "admin_max_range_note": "Hvor langt unna et fly fortsatt regnes som «i rekkevidde» — gjelder alle datakilder, ikke bare lokal antenne. Kan trygt settes høyt siden det ikke koster noe ekstra å øke den, uansett kilde — sjekk faktisk rekkevidde under «Finding your antenna's real range» i README.",
    ...
    "en": {
        ...
        "admin_max_range_note": "How far away an aircraft still counts as \"in range\" — applies to every data source, not just local antenna. Safe to set high since increasing it costs nothing extra regardless of source — check your antenna's real range under \"Finding your antenna's real range\" in the README.",
