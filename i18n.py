...
STRINGS = {
    "no": {
        ...
        "stat_altitude": "Høyde",
        "stat_speed": "Fart",
        "stat_distance": "Avstand",
        "stat_squawk": "Squawk",
        "unknown_altitude": "Ukjent",
        "unknown_altitude_tooltip": "Kun Mode S \u2014 ingen posisjon/høyde kringkastet nylig",
        ...
        "admin_setup_title": "Velkommen — sett et admin-passord",
        "admin_setup_body": "Ingen admin-passord er satt opp ennå. Velg ett nå for å komme i gang — ingen terminal nødvendig.",
        "admin_setup_button": "Lagre og logg inn",
        "admin_setup_error_length": "Passordet må være minst 8 tegn.",
        "admin_setup_error_match": "Passordene er ikke like.",
        "admin_advanced": "Avansert",
        "admin_port": "Port",
        "admin_state_file": "Sti til state-fil",
        "admin_updates": "Oppdateringer",
        "admin_auto_update_enabled": "Automatiske nattlige oppdateringer",
        "admin_update_hour": "Kjøretidspunkt",
        "admin_update_note": "Henter siste versjon fra git hver natt (kun hvis skjermen faktisk har nye commits), installerer eventuelle nye avhengigheter, og starter tjenesten på nytt automatisk. Ingen manuell handling nødvendig.",
        "admin_check_update_now": "Sjekk etter oppdateringer nå",
        "admin_update_status_up_to_date": "Oppdatert \u2014 du har allerede nyeste versjon",
        "admin_update_status_updated": "Oppdatert til {commit}",
        "admin_update_available": "Ny versjon tilgjengelig: {commit}",
        "admin_apply_update_now": "Oppdater nå",
        "admin_update_status_error": "Feil ved oppdatering",
        "admin_last_checked": "Sist sjekket",
        "admin_restart_required": "Krever omstart av tjenesten for å tre i kraft",
    ...
    "en": {
        ...
        "stat_squawk": "Squawk",
        "unknown_altitude": "Unknown",
        "unknown_altitude_tooltip": "Mode S only \u2014 no position/altitude broadcast recently",
        ...
        "admin_setup_title": "Welcome — set an admin password",
        "admin_setup_body": "No admin password is configured yet. Choose one now to get started — no terminal required.",
        "admin_setup_button": "Save and log in",
        "admin_setup_error_length": "Password must be at least 8 characters.",
        "admin_setup_error_match": "Passwords don't match.",
        "admin_advanced": "Advanced",
        "admin_port": "Port",
        "admin_state_file": "State file path",
        "admin_updates": "Updates",
        "admin_auto_update_enabled": "Automatic nightly updates",
        "admin_update_hour": "Run time",
        "admin_update_note": "Pulls the latest version from git every night (only if there are actually new commits), installs any new dependencies, and restarts the service automatically. No manual action needed.",
        "admin_check_update_now": "Check for updates now",
        "admin_update_status_up_to_date": "Up to date \u2014 you already have the latest version",
        "admin_update_status_updated": "Updated to {commit}",
        "admin_update_available": "New version available: {commit}",
        "admin_apply_update_now": "Apply update now",
        "admin_update_status_error": "Update failed",
        "admin_last_checked": "Last checked",
        "admin_restart_required": "Requires a service restart to take effect",
