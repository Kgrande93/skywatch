...
STRINGS = {
    "no": {
        ...
        "admin_max_range_note": "Hvor langt unna et fly fortsatt regnes som «i rekkevidde». Kan trygt settes høyt for lokal antenne (gratis) — sjekk faktisk rekkevidde under «Finding your antenna's real range» i README.",
    ...
    "en": {
        ...
        "admin_max_range_note": "How far away an aircraft still counts as \"in range\". Safe to set high for a local antenna (free) — check your antenna's real range under \"Finding your antenna's real range\" in the README.",
